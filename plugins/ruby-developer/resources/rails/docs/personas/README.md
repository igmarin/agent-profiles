...
|-----------|----------------|--------|
| [development.md](development.md) | [`tdd`](../../../../skills/rails-tdd/SKILL.md) | Active |
| [review.md](review.md) | [`review`](../../../../skills/rails-review/SKILL.md) | Active |
| [setup.md](setup.md) | [`setup`](../../../../skills/rails-setup/SKILL.md) | Active |
| [quality.md](quality.md) | [`quality`](../../../../skills/rails-quality/SKILL.md) | Active |
| [engines.md](engines.md) | [`engine`](../../../../skills/rails-engine/SKILL.md) | Active |
...
|-----------|---------|-------------|
| **Bug fix** | [`bug-fix`](../../../../skills/rails-bug-fix/SKILL.md) | `triage-bug` *(from core)* → reproduce test → fix → verify |
...
| **GraphQL** | [`graphql`](../../../../skills/rails-graphql/SKILL.md) | domain modeling *(from core)* → schema → TDD → security |
...
| **Database migration** | [`migration`](../../../../skills/rails-migration/SKILL.md) | plan → test → staging → production |
| **Background job** | [`background-job`](../../../../skills/rails-background-job/SKILL.md) | design → TDD → retry config → monitoring |
