...
| Skill | When to chain |
|-------|---------------|
| [create-engine](../../../../skills/rails-create-engine/SKILL.md) | When designing the engine structure that installers will configure |
| [document-engine](../../../../skills/rails-document-engine/SKILL.md) | When documenting install steps or upgrade instructions |
| [test-engine](../../../../skills/rails-test-engine/SKILL.md) | When adding generator specs or dummy-app install coverage |
