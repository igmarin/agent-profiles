...
license: MIT
description: >
  Use when choosing the first failing spec for a Rails change.
  One minimal example opens the gate. Trigger words: first failing test,
  what test first, TDD, spec selection.
metadata:
  version: 1.0.0
  user-invocable: "true"
---
...
6. **Hand off:** Continue with the skill that fits the slice — [`write-tests`](../../../../../skills/rails-write-tests/SKILL.md) for general spec writing, [`test-service`](../../../../../skills/rails-test-service/SKILL.md) for service-layer coverage, or [`test-engine`](../../../../../skills/rails-test-engine/SKILL.md) for engine integration.
