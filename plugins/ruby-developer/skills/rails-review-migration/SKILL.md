...
description: 'Use when planning or reviewing a production Rails migration. Never mix
  schema change and backfill. Trigger words: migration, add column, index, backfill,
  zero-downtime.'
license: MIT
metadata:
  source-id: igmarin/rails-agent-skills:review-migration
