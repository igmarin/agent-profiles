---
name: rails-security-check
description: 'Use when auditing a Rails app for XSS, CSRF, SQLi, IDOR, secrets, or
  auth bypass. Never print secrets. Trigger words: security, audit, XSS, CSRF, SQL
