...
description: 'Use when running a safe migration loop: plan, test up/down, staging,
  production. Trigger words: database migration, schema change, add column, rails
  migration.'
license: MIT
metadata:
