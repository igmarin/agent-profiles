---
name: rails-review-engine
description: 'Use when reviewing a Rails engine for isolation, API surface, and host
  contract. Trigger words: review engine, engine quality, engine audit.'
license: MIT
metadata:
