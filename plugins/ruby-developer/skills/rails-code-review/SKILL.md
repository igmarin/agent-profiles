...
description: 'Use when reviewing a Rails PR, diff, or merge request. Ground findings
  in a real file:line. Trigger words: review PR, code review, review my diff, CR.'
license: MIT
metadata:
