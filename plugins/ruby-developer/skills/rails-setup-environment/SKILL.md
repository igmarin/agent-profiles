---
name: rails-setup-environment
description: 'Use when onboarding onto a Rails app: Ruby version, Docker, env, database,
  test suite. Do not execute setup or echo secrets. Trigger words: onboarding, setup
  project, Docker, getting started.'
license: MIT
metadata:
