---
name: rails-generate-api-collection
description: 'Use when creating or updating a REST API collection for Rails endpoints.
  Do not use for GraphQL. Trigger words: Postman, API collection, endpoint, API route,
  request collection.'
license: MIT
metadata:
