---
name: rails-extract-engine
description: 'Use when extracting a host-app feature into a Rails engine. Do not change
  behavior in the same step. Trigger words: extract to engine, move feature, host
  coupling.'
license: MIT
metadata:
