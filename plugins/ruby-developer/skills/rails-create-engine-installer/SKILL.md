---
name: rails-create-engine-installer
description: 'Use when writing an install generator for a Rails engine (migrations,
  config). Trigger words: install generator, engine setup, copy migrations.'
license: MIT
metadata:
...
| Skill | When to chain |
|-------|---------------|
| [create-engine](../rails-create-engine/SKILL.md) | When designing the engine structure that installers will configure |
| [document-engine](../rails-document-engine/SKILL.md) | When documenting install steps or upgrade instructions |
| [test-engine](../rails-test-engine/SKILL.md) | When adding generator specs or dummy-app install coverage |
