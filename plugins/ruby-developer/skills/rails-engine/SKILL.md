---
name: rails-engine
description: 'Use when running the full engine loop: author, test, review, release.
  Trigger words: create engine, extract engine, engine release, mountable engine.'
license: MIT
metadata:
  source-id: igmarin/rails-agent-skills:engine
  source-commit: 9c639c4de86a88075d78094bbeee203be8356cc1
  kind: workflow
  dependencies: '["igmarin/rails-agent-skills:create-engine", "igmarin/rails-agent-skills:test-engine",
    "igmarin/rails-agent-skills:review-engine", "igmarin/rails-agent-skills:document-engine",
    "igmarin/rails-agent-skills:release-engine", "igmarin/rails-agent-skills:upgrade-engine",
    "igmarin/ruby-core-skills:write-yard-docs", "igmarin/ruby-core-skills:tdd-process"]'
---
