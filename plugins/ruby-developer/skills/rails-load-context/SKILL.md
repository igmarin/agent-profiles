---
name: rails-load-context
description: 'Use before writing code, specs, or a PRD in an existing Rails app. Load
  schema, routes, and one neighbor per layer. Trigger words: load context, before
  I code, existing patterns.'
license: MIT
metadata:
