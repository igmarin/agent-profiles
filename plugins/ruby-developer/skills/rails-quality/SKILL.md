---
name: rails-quality
description: 'Use for a pre-PR quality sweep: conventions, refactor, docs, linters,
  suite. Trigger words: before PR, quality sweep, production-ready, quality audit.'
license: MIT
metadata:
  ...
  dependencies: '["igmarin/rails-agent-skills:apply-code-conventions", "igmarin/rails-agent-skills:apply-stack-conventions",
    ...
    "igmarin/ruby-core-skills:write-yard-docs", "igmarin/ruby-core-skills:refactor-process",
    "igmarin/ruby-core-skills:review-process"]'
---
