---
name: planning-agnostic-planning-skills
description: 'Use when discovering which planning skill or persona to run. Covers
  PRDs, tasks, tickets, backlog, sprint, retro, status, risks, GitHub issues, and
  the four personas. Trigger words: planning, PRD, tasks, tickets, estimation, risks,
  status, backlog, sprint, retrospective, agile, product management.'
license: MIT
metadata:
  source-id: igmarin/agnostic-planning-skills:agnostic-planning-skills
