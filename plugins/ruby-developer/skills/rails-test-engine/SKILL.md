---
name: rails-test-engine
description: 'Use when setting up or reviewing dummy-app and engine specs. Trigger
  words: test engine, dummy app, engine specs.'
license: MIT
metadata:
  source-id: igmarin/rails-agent-skills:test-engine
