---
name: rails-rails-agent-skills
description: 'Use when starting Rails work and the matching atomic skill is not obvious.
  Coordinates the Rails skill catalog. Trigger words: Rails, RSpec, TDD, GraphQL,
  engine, migration, code review, background job.'
license: MIT
metadata:
  source-id: igmarin/rails-agent-skills:rails-agent-skills
