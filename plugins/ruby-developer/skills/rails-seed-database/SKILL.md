...
description: 'Use when choosing seeds, fixtures, or factories for Rails dev/test data.
  Seeds must be idempotent. Trigger words: seeds, fixtures, test data, development
  data.'
license: MIT
metadata:
