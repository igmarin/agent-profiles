---
name: ruby-define-domain-language
description: 'Use when a Ruby feature, bug, or architecture discussion has fuzzy business
  terminology and you need shared vocabulary. Identifies canonical terms, resolves
  naming conflicts, maps synonyms to one concept, and generates a glossary for Ruby-first
  workflows. Trigger words: DDD, shared vocabulary, define terms, bounded context
  naming, what should we call this, terminology alignment, DDD glossary, naming inconsistency.'
license: MIT
metadata:
  source-id: igmarin/ruby-core-skills:define-domain-language
...
- [EXAMPLES.md](../../resources/ruby/skills/define-domain-language/EXAMPLES.md) — Naming-inconsistency example and resolved glossary.
- [assets/examples.md](../../resources/ruby/skills/define-domain-language/assets/examples.md) — JSON glossary entry example.
- [assets/glossary_schema.json](../../resources/ruby/skills/define-domain-language/assets/glossary_schema.json) — Optional schema for persisted glossary entries.
