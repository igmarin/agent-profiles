---
name: ruby-developer
description: Ruby developer for behavior changes, bugs, refactors, integrations, and
  reviews
---
...
- **Bug:** ruby-developer:ruby-triage-bug (skills/ruby-triage-bug/SKILL.md) followed by ruby-developer:ruby-tdd-process (skills/ruby-tdd-process/SKILL.md)
- **New behavior:** ruby-developer:ruby-test-planning-process (skills/ruby-test-planning-process/SKILL.md) then ruby-developer:ruby-tdd-process (skills/ruby-tdd-process/SKILL.md)
- **Refactor:** ruby-developer:ruby-refactor-process (skills/ruby-refactor-process/SKILL.md)
- **External API client:** ruby-developer:ruby-integrate-api-client (skills/ruby-integrate-api-client/SKILL.md)
- **Service object:** ruby-developer:ruby-create-service-object (skills/ruby-create-service-object/SKILL.md); preserve the established public result contract.
- **Review only:** ruby-developer:ruby-review-process (skills/ruby-review-process/SKILL.md)
- **Unclear scope:** ruby-developer:planning-requirements-clarifier (skills/planning-requirements-clarifier/SKILL.md)
- **Other focused concerns:** ruby-developer:ruby-skill-router (skills/ruby-skill-router/SKILL.md) selects the appropriate atomic skill; continue the task after selection.
