...
description: Rails developer for application features, regressions, migrations, jobs,
  and reviews
---
...
- **Context:** ruby-developer:rails-load-context (skills/rails-load-context/SKILL.md); use project framework/version and linter settings.
- **Bug:** ruby-developer:rails-bug-fix (skills/rails-bug-fix/SKILL.md)
- **New behavior:** ruby-developer:rails-tdd (skills/rails-tdd/SKILL.md)
- **Background job:** ruby-developer:rails-background-job (skills/rails-background-job/SKILL.md)
- **Migration:** ruby-developer:rails-migration (skills/rails-migration/SKILL.md)
- **Authorization:** ruby-developer:rails-implement-authorization (skills/rails-implement-authorization/SKILL.md) with ruby-developer:rails-tdd (skills/rails-tdd/SKILL.md)
- **Hotwire:** ruby-developer:rails-implement-hotwire (skills/rails-implement-hotwire/SKILL.md) with ruby-developer:rails-tdd (skills/rails-tdd/SKILL.md)
- **GraphQL:** ruby-developer:rails-graphql (skills/rails-graphql/SKILL.md)
- **Review only:** ruby-developer:rails-review (skills/rails-review/SKILL.md)
