---
name: planning-project-manager
description: 'Use when tracking a sprint or project, assessing execution health, flagging
  blockers, or writing a stakeholder update. Trigger words: project manager, execution
  tracking, estimates, risk register, status report, blockers, milestone tracking.'
license: MIT
metadata:
