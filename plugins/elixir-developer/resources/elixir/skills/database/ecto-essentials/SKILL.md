...
- **Prerequisite:** [elixir-essentials](../../../../../skills/elixir-elixir-essentials/SKILL.md) — core Elixir patterns before working with Ecto
- **Next — changeset deep-dive:** [ecto-changeset-patterns](../../../../../skills/elixir-ecto-changeset-patterns/SKILL.md) — advanced validations, custom constraints, and error formatting
- **Next — testing:** [testing-essentials](../../../../../skills/elixir-testing-essentials/SKILL.md) — testing Ecto contexts and migrations
