---
name: elixir-otp-essentials
description: "MANDATORY for ALL OTP work. Invoke before writing GenServer, Supervisor,\
  \ Task, or Agent modules. Processes are for concurrency, state, and isolation \u2014\
  \ not code organization. Keep callbacks thin; pure modules do the work (FCIS). Covers\
  \ GenServer API, handle_continue, call vs cast, supervision, Task, Agent, Registry,\
  \ ETS. Trigger words: GenServer, Supervisor, OTP, Task, Agent, Registry, ETS, process,\
  \ supervision, thin callbacks."
license: MIT
metadata:
  source-id: igmarin/elixir-phoenix-skills:otp-essentials
...
Canonical FP bar: [`docs/fcis-engineering-rules.md`](../../resources/elixir/docs/fcis-engineering-rules.md).
