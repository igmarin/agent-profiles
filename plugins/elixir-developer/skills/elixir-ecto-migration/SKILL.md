---
name: elixir-ecto-migration
description: "Safe migration playbook with hard gates and HITL for production risk:\
  \ plan locks/rollback \u2192 implement schema-only migration \u2192 migrate/rollback/re-migrate\
  \ \u2192 never mix backfill \u2192 expand-contract for NOT NULL \u2192 suite green.\
