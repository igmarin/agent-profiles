---
name: elixir-phoenix-channels-essentials
description: 'Handles all Phoenix Channels work. Use when building socket authentication,
  topic authorization, handle_in patterns, Presence tracking, or channel testing.
  Covers non-LiveView real-time features for mobile clients, SPAs, and external APIs.
  Trigger words: Channels, socket, channel, Presence, handle_in, topic, real-time,
  WebSocket.'
license: MIT
metadata:
  source-id: igmarin/elixir-phoenix-skills:phoenix-channels-essentials
...
Canonical FP bar: [`docs/fcis-engineering-rules.md`](../../resources/elixir/docs/fcis-engineering-rules.md) — **Functional Core, Imperative Shell**: pure domain modules; side effects at edges. Keep LiveView/controller callbacks thin; delegate business rules to contexts/pure modules.
...
Use `Phoenix.ChannelTest` to test socket connections, joins, and message handling. See [`../../resources/elixir/skills/phoenix/phoenix-channels-essentials/assets/channel_test_template.md`](../../resources/elixir/skills/phoenix/phoenix-channels-essentials/assets/channel_test_template.md) for a copy-paste template; the core cases are:
