---
name: elixir-ecto-changeset-patterns
description: 'MANDATORY for ALL changeset work beyond basic CRUD. Invoke before writing
  multiple changesets, cast_assoc, or conditional validation. Covers separate changesets
  per operation, cast_assoc pitfalls, composition, conditional validation with opts,
  field transformations, and uniqueness validation. Trigger words: changeset, cast_assoc,
  validation, separate changesets, conditional validation, update_change.'
license: MIT
metadata:
  source-id: igmarin/elixir-phoenix-skills:ecto-changeset-patterns
