---
name: elixir-elixir-skill-router
description: Use when an Elixir/Phoenix request spans multiple concerns or the next
  workflow is unclear. Route implementation, bugs, reviews, setup, LiveView, jobs,
  and migrations to the installed playbook and relevant domain skills.
license: MIT
metadata:
  ...
  dependencies: '["igmarin/elixir-phoenix-skills:tdd", "igmarin/elixir-phoenix-skills:bug-fix",
    ...
    "igmarin/elixir-phoenix-skills:setup", "igmarin/elixir-phoenix-skills:liveview",
    "igmarin/elixir-phoenix-skills:background-job", "igmarin/elixir-phoenix-skills:ecto-migration",
    "igmarin/elixir-phoenix-skills:elixir-essentials", "igmarin/elixir-phoenix-skills:phoenix-liveview-essentials",
    "igmarin/elixir-phoenix-skills:testing-essentials", "igmarin/elixir-phoenix-skills:ecto-essentials",
    "igmarin/elixir-phoenix-skills:code-review", "igmarin/elixir-phoenix-skills:code-quality",
    "igmarin/elixir-phoenix-skills:credo-config", "igmarin/elixir-phoenix-skills:oban-essentials"]'
---
