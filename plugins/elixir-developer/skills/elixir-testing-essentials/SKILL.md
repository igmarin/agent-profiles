---
name: elixir-testing-essentials
description: 'MANDATORY for ALL test files. Invoke before writing any _test.exs file.
  ...
  async safety, setup chaining, timestamp testing, and TDD workflow. Trigger words:
  test, mix test, DataCase, ConnCase, fixture, LiveView test, assert, ExUnit.'
license: MIT
metadata:
