---
name: planning-product-owner
description: 'Use when planning a feature, running product discovery, defining requirements,
  or preparing a sprint backlog. Trigger words: product owner, PRD, discovery, requirements,
  task breakdown, tickets, sprint backlog, scope a feature.'
license: MIT
metadata:
  source-id: igmarin/agnostic-planning-skills:product-owner
  source-commit: ae074f9c8718013a6b2c618b3856e6914986b775
  kind: role
  dependencies: '["igmarin/agnostic-planning-skills:create-prd", "igmarin/agnostic-planning-skills:generate-tasks",
    "igmarin/agnostic-planning-skills:plan-tickets"]'
---
