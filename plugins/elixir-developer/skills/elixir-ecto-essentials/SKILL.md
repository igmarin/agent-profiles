---
name: elixir-ecto-essentials
description: 'MANDATORY for ALL Elixir database work. Invoke before modifying schemas,
  queries, or migrations. Covers schema definition, changesets, query composition,
  preloading, transactions, associations, migrations, upserts, dynamic queries, and
  the context pattern. Trigger words: Ecto, schema, changeset, migration, Repo, query,
  preload, association, belongs_to, has_many, Elixir database.'
license: MIT
metadata:
...
Canonical FP bar: [`docs/fcis-engineering-rules.md`](../../resources/elixir/docs/fcis-engineering-rules.md) — **Functional Core, Imperative Shell**: pure domain modules; side effects at edges. Build changesets/Multi in pure-ish functions; run `Repo` once at the context edge.
...
- **Prerequisite:** [elixir-essentials](../elixir-elixir-essentials/SKILL.md) — core Elixir patterns before working with Ecto
- **Next — changeset deep-dive:** [ecto-changeset-patterns](../elixir-ecto-changeset-patterns/SKILL.md) — advanced validations, custom constraints, and error formatting
- **Next — testing:** [testing-essentials](../elixir-testing-essentials/SKILL.md) — testing Ecto contexts and migrations
