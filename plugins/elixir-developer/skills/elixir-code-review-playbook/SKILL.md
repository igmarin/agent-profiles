---
name: elixir-code-review-playbook
description: "Sequenced PR/diff review workflow with hard gates and optional HITL\
  \ on Critical fixes: integrity of PR text \u2192 load atomic review rules \u2192\
  \ walk Review Order \u2192 severity findings \u2192 handoff task list \u2192 re-review\
  \ after Critical changes. Trigger: code review, PR review, review my diff, review\
  \ before merge, self-review, code audit."
license: MIT
metadata:
