---
name: elixir-quality
description: "Pre-PR quality loop with hard gates: mix format, credo, dialyzer, hex.audit,\
  \ full tests \u2192 optional FCIS-safe refactor with characterization tests and\
  \ scope checks \u2192 docs/specs on public APIs. Trigger: before PR, quality sweep,\
  \ production readiness, credo, dialyzer, refactor for PR."
license: MIT
metadata:
