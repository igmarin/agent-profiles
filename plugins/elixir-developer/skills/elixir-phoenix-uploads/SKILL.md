...
description: 'MANDATORY for file upload features. Invoke before implementing upload
  or file serving functionality. Covers manual uploads, upload configuration, file
  validation, safe filenames, static paths, and template patterns. Trigger words:
  upload, file upload, allow_upload, consume_uploaded_entries, static_paths, file
  serving.'
license: MIT
metadata:
  source-id: igmarin/elixir-phoenix-skills:phoenix-uploads
