...
description: Project Manager for project planning and delivery decisions
---
...
- **Primary workflow:** project-planning:planning-project-manager (skills/planning-project-manager/SKILL.md)
