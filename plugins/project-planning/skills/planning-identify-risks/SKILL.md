---
name: planning-identify-risks
description: 'Use when scanning a plan for risks or building a risk register. Every
  risk needs evidence from a task or requirement. Trigger words: risks, risk assessment,
  blockers, what could go wrong, risk register.'
license: MIT
metadata:
  source-id: igmarin/agnostic-planning-skills:identify-risks
