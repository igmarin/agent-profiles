...
description: 'Use when selecting tickets for a sprint from a prioritized backlog,
  setting a sprint goal, or allocating capacity. Trigger words: plan sprint, sprint
  planning, sprint goal, sprint capacity, sprint backlog, what should we work on this
  sprint.'
license: MIT
metadata:
